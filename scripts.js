...
typewriter.typeString('hello and welcome!')
    ...
    .deleteAll()
    .pauseFor(500)
    .typeString('its lovely to meet you')
    .pauseFor(1000)
    .deleteAll()
    .pauseFor(500)
    .typeString("my name is rabiea.")
    .pauseFor(1000)
    .deleteAll()
    .pauseFor(500)
    .typeString("i graduated from uc berkeley")
    .pauseFor(1000)
    .deleteAll()
    .pauseFor(500)
    .typeString("i studied cognitive science with an emphasis in computer science")
    .pauseFor(1000)
    .deleteAll()
    .pauseFor(500)
    .typeString("i also love design")
    .pauseFor(1000)
    .deleteAll()
    .pauseFor(500)
    .typeString("im a big coffee enthusiast")
    .pauseFor(1000)
    .deleteAll()
    .pauseFor(500)
    .typeString("and a huge book reader")
    .pauseFor(1000)
    .deleteAll()
    .pauseFor(500)
